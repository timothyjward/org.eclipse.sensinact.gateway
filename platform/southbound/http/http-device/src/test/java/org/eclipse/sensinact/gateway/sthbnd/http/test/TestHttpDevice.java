...
//        response = (SnaMessage) midVariable.toOSGi(getMethod, new Object[]{DataResource.VALUE, null});
    ...
    @Test
    public void testHttpTaskWithProcessingContext(@InjectService(timeout = 500) Core core, @InjectInstalledBundle(value = "resources5.jar") Bundle bundle) throws Throwable {
...
//        response = (SnaMessage) midVariable.toOSGi(getMethod, new Object[]{DataResource.VALUE, null});
    ...
    @Test
    public void testHttpTaskWithServicesEnumeration(@InjectService(timeout = 500) Core core, @InjectInstalledBundle(value = "resources4.jar") Bundle bundle) throws Throwable {
...
//        response = (SnaMessage) midVariable.toOSGi(getMethod, new Object[]{DataResource.VALUE, null});
    ...
    @Test
    public void testChainedHttpTask(@InjectService(timeout = 500) Core core, @InjectInstalledBundle(value = "resources3.jar") Bundle bundle) throws Throwable {
...
//        SnaMessage response = (SnaMessage) midVariable.toOSGi(getMethod, new Object[]{DataResource.VALUE, null});
    ...
    @Test
    public void testHttpDeviceReccurrent(@InjectService(timeout = 500) Core core, @InjectInstalledBundle(value = "resources2.jar") Bundle button) throws Throwable {
